...
RUN apt-get install -y -q make gcc g++ libc-dev pkg-config cmake-data dpkg-dev mingw-w64 cmake unzip python3 libxaw7-dev libxrandr-dev libgl1-mesa-dev wget autoconf \
